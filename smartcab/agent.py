...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = math.cos(0.0005 * self.t)
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            # Not considering future rewards so not using future state of the agent
...
def run():
    ...
    sim = Simulator(env, update_delay=0.000001, log_metrics=True, display=True, optimized=True)
